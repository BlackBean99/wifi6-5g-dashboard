...
//        return listOf()
//    }
//    fun getNetworkInfo(networkIds : List<String>): List<ClientData> {
////        return merakiClient.getN();
//        return listOf()
//    }
//
//    fun getClientsByNetworkId(networkId: String): Clients {
////        return merakiClient.getClientByNetworkId(networkId);
//        return Clients(0, "서현");
//    }
//}
