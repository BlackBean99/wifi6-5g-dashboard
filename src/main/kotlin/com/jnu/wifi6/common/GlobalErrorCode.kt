...
import com.jnu.wifi6.common.consts.BAD_REQUEST
import com.jnu.wifi6.common.consts.FORBIDDEN
import com.jnu.wifi6.common.consts.INTERNAL_SERVER
import com.jnu.wifi6.common.consts.METHOD_NOT_ALLOWED
import com.jnu.wifi6.common.consts.NOT_FOUND
import com.jnu.wifi6.common.consts.REQUEST_TIMEOUT
...
enum class GlobalErrorCode(val status: Int, val code: String, val reason: String) : BaseErrorCode {
    ...
    OTHER_SERVER_UNAUTHORIZED(UNAUTHORIZED, "OTHER_SERVER_401_1", "다른 서버에서 인증되지 않은 요청을 보냈습니다."),

    @ExplainError("다른 서버에서 발생한 인증 예외입니다.")
    OTHER_SERVER_FORBIDDEN(FORBIDDEN, "OTHER_SERVER_403_1", "다른 서버에서 인증되지 않은 요청을 보냈습니다."),
